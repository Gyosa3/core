...
FORECAST_MODE_HOURLY = "Free - 3-hour for 5 days"
FORECAST_MODE_DAILY = "Paid - Daily for 16 days"
FORECAST_MODE_ONECALL_HOURLY = "Paid OneCall - Hourly for 2 days"
FORECAST_MODE_ONECALL_DAILY = "Paid OneCall - Daily for 8 days"
FORECAST_MODES = [
